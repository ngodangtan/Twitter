...
class TweetHeader: UICollectionReusableView {
    ...
    override init(frame: CGRect) {
        ...
        dataLabel.anchor(top:captionLabel.bottomAnchor,left:leftAnchor,paddingTop: 20,paddingLeft: 16)
        ...
        statsView.anchor(top: dataLabel.bottomAnchor, left: leftAnchor, right: rightAnchor,paddingTop: 12,height: 40)
    ...
    func configure(){
        ...
        dataLabel.text = viewModel.headerTimestamp
